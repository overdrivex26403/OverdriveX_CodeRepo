...
@TeleOp(name = "OverdriveX_Teleop_V4", group = "Robot")
public class OverdriveX_Teleop_V4 extends LinearOpMode {
    ...
    private double OPEN_CLAW = 0;
    private double CLOSED_CLAW = 0.3;
    ...
    private static int INIT_VIPER_POSITION = 300;
    ...
    private static final int MIN_ARM_MOTOR_POS = 0;
    private static final int SCORE_ARM_MOTOR_POS = 325;
    private static final int PICK_ARM_MOTOR_POS = 700;
    private static final int REST_ARM_MOTOR_POS = 0;         
    private static final int VERT_ARM_MOTOR_POS = 340;         
    private static final int MAX_ARM_MOTOR_POS = 775;
    private double ARM_POWER = 0.1;
    ...
    private void setupViperslideAndArmMotors() {
    ...
    Arm_Motor.setTargetPositionTolerance(POSITION_TOLERANCE);
    ...
    moveArmMotor(REST_ARM_MOTOR_POS);    
    ...
    private void moveArmMotor(int finalPos) {
        Arm_Motor.setTargetPosition(finalPos);
    ...
    private void controlScoring() {
        ...
        // Servo no longer in use
            // armPosition += 0.05;
        armPosition = Arm_Motor.getCurrentPosition();
        armPosition += 50; 
            //LeftArm.setPosition(armPosition);
        moveArmMotor(armPosition);
